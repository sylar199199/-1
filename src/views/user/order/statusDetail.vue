...
<template>
    <div class="statusDetail" v-if="showData">
        <div style="padding-bottom: 100px;">
            ...
            <div class="orderDeatileTime color97 font24"  v-if="status == 2 || status == 5" style="padding-bottom:10px;">有疑问请拨打官方客服电话 <a class="color97 font24" href="tel:400-811-8899">4400-811-8899</a></div>
             </div>
            ...
            <div class="showAdress" v-if="status == 3 && !afs.expressName && !afs.expressNo">
                ...
                <div class="returnAdress font24 color97" v-if="adress">卖家已经同意您的退货，请将产品退回到如下地址：{{adress.province}} {{adress.city}} {{adress.district}} {{adress.address}} {{adress.contact}} {{adress.tel}}</div>
            </div>
            <div class="showAdress" v-if="status == 2 || status == 5">
                ...
                <div class="addressBoxone">
                    卖家核实完毕，拒绝退货。如有疑问请拨打官方客服电话 400-811-8899.
                </div>
            </div>
