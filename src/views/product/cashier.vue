<template>
  <div class="container">
    ...
    <div class="bottom">
      <span class="price">总计<span>￥{{amount}}</span></span>
    ...
    methods: {
      ...
      payNow() {
        ...
        if (that.payType == 1) {
          ...
          let reUrl = `${Global.clientInfo.payReturnDomain}?xjkPayId=${payId}`;
          // 支付宝支付
          let sUserAgent = navigator.userAgent;
        ...
        WeixinJSBridge.invoke(
          ...
          function (res) {
            if (res.err_msg == "get_brand_wcpay_request:ok") {
              ...
              let reUrl = `${Global.clientInfo.payReturnDomain}?xjkPayId=2623`
              ...
              let reUrl = Global.clientInfo.payReturnDomain;
              window.location.href = reUrl
            } else {
              Toast({
                message: '支付失败',
