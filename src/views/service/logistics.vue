    ...
    <div class="helpcenter">
        <div class="showAdress">
            <div class="infoBox">
                ...
                <span class="name">{{express.expressName}}</span>
                <span class="font24 color1e">{{express.expressNo}}</span>
                <span class="font24 color97 fr" :data-clipboard-text="express.expressNo" id="tags" @click="copy()">复制单号</span>
            </div>
        </div>
    </div>
</template>
